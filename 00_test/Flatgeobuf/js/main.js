...
var map = new maplibregl.Map({
    container: 'map',
    style: {
        center: [140.88375,37.04189], // 日本全体
        zoom: 17, // ズームレベル
        minZoom: 5,
        maxZoom: 23,
        version: 8,
...
//法務省地図ポリゴン（FlatGeoBuf）ここから
		...
		var Lat02 = LngLatBounds.getSouth();	//南
            ...
            async function updateResults() {
                ...
                let iter = flatgeobuf.deserialize("https://habs.rad.naro.go.jp/spatial_data/amxpoly47/amxpoly_2022_" + "07" + ".fgb", fgBoundingBox());
